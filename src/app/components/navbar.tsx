  ...
  return (
    <div className='text-white flex flex-col'>
      ...
      <div className='flex justify-evenly mt-2 mb-2 mx-4 es:mx-0 '>
        {/*Logo */}
        <div>
          <h1 className='text-center mt-1 text-[9px] font-semibold text-white -500 leading-3 es:text-[10px] sm:text-[15px] scale-105'><strong className='text-red-600 font-black'>N</strong>  Trav<strong className='text-red-600'>el</strong> <br /> <strong className='text-yellow-200 '>Guide</strong></h1>
        </div>
         <div>
...
<div className='h-[1px] bg-slate-300 '></div>
      ...
      <div className='flex justify-center mt-2'>
        <ul className='flex space-x-1 text-[11px] font-medium es:font-medium es:text-[15px] sm:text-[18px] sm:font-medium md:space-x-6'>
            ...
            <Link href={"#contact"} className='pointer hover:scale-110 transition-transform duration-500'>Contact Me   </Link>
        </ul>
      </div>
    </div>
  )
